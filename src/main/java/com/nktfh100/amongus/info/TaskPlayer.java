 ...
 public class TaskPlayer
 {
   ...
   public void taskDone() {
     if (this.state >= this.tasks.size() || this.pInfo.getIsImposter().booleanValue()) {
       return;
     }
     getActiveTask().getHolo().getVisibilityManager().hideTo(this.pInfo.getPlayer());
     String name_ = Main.getMessagesManager().getTaskName(getActiveTask().getTaskType().toString());
     this.pInfo.getPlayer().sendTitle(Main.getMessagesManager().getGameMsg("finishTaskTitle", this.pInfo.getArena(), name_, getActiveTask().getLocationName().getName()), 
         Main.getMessagesManager().getGameMsg("finishTaskSubTitle", this.pInfo.getArena(), name_, getActiveTask().getLocationName().getName()), 15, 40, 20);
     ...
     if (!getIsDone().booleanValue()) {
       ...
       this.pInfo.getArena().getTasksManager().updateTasksDoneBar(Boolean.valueOf(true));
       Boolean allTasksDone = Boolean.valueOf(true);
       for (TaskPlayer tp : this.pInfo.getArena().getTasksManager().getTasksForPlayer(this.pInfo.getPlayer())) {
         if (!tp.getIsDone().booleanValue()) {
           allTasksDone = Boolean.valueOf(false);
           break;
         } 
       } 
       if (allTasksDone.booleanValue()) {
   ...
   public void updateTasksVars() {
     ...
     this.maze_ = null;
     switch (getActiveTask().getTaskType()) {
       case WIRING:
       ...
       case REFUEL:
       case FUEL:
         this.fuelProgress_ = Integer.valueOf(0);
         break;
       case INSPECT_SAMPLE:
         this.inspectTimer_ = Integer.valueOf(60);
         this.inspectIsRunning_ = Boolean.valueOf(false);
         this.inspectAnomaly_ = Integer.valueOf(-1);
         break;
       case START_REACTOR:
         this.moves_ = TaskStartReactorInv.generateMoves();
         this.reactorState_ = Integer.valueOf(0);
         break;
       case CLEAR_ASTEROIDS:
         this.asteroidsDestroyed_ = Integer.valueOf(0);
         break;
       case FILL_CANISTERS:
         this.canistersLeft_ = Integer.valueOf(2);
         break;
       case REPLACE_WATER_JUG:
         this.waterJugProgress_ = Integer.valueOf(0);
         break;
       case REBOOT_WIFI:
         this.rebootTimer_ = Integer.valueOf(60);
         this.rebootIsRunning_ = Boolean.valueOf(false);
         break;
   ...
   public Boolean getIsDone() { return (this.state >= this.tasks.size()) ? Boolean.valueOf(true) : Boolean.valueOf(false); }
   ...
   public ArrayList<String> getWires_() { return this.wires_; }
 
 
   
   public String getActiveLocation_() { return this.activeLocation_; }
 
 
   
   public ArrayList<String> getLocations_() { return this.locations_; }
 
 
   
   public Integer getActiveLever_() { return this.activeLever_; }
   ...
   public ArrayList<Integer> getNumbers_() { return this.numbers_; }
 
 
   
   public ArrayList<Boolean> getSquares_() { return this.squares_; }
 
 
   
   public ArrayList<Integer> getLeaves_() { return this.leaves_; }
 
 
   
   public void setFuelProgress_(Integer to) { this.fuelProgress_ = to; }
 
 
   
   public Integer getFuelProgress_() { return this.fuelProgress_; }
 
 
   
   public Integer getInspectTimer_() { return this.inspectTimer_; }
   ...
   public Boolean getInspectIsRunning_() { return this.inspectIsRunning_; }
 
 
   
   public void setInspectIsRunning_(Boolean inspectIsRunning) { this.inspectIsRunning_ = inspectIsRunning; }
 
 
   
   public Integer getInspectAnomaly_() { return this.inspectAnomaly_; }
 
 
   
   public Integer getReactorState_() { return this.reactorState_; }
 
 
   
   public void setReactorState_(Integer reactorState_) { this.reactorState_ = reactorState_; }
 
 
   
   public ArrayList<Integer> getMoves_() { return this.moves_; }
 
 
   
   public Integer getAsteroidsDestroyed_() { return this.asteroidsDestroyed_; }
 
 
   
   public void setAsteroidsDestroyed_(Integer asteroidsDestroyed) { this.asteroidsDestroyed_ = asteroidsDestroyed; }
 
 
   
   public Integer getSelectedQueuedVariant() { return this.selectedQueuedVariant; }
 
 
   
   public Integer getCanistersLeft_() { return this.canistersLeft_; }
 
 
   
   public void setCanistersLeft_(Integer canistersLeft) { this.canistersLeft_ = canistersLeft; }
 
 
   
   public Integer getWaterJugProgress_() { return this.waterJugProgress_; }
 
 
   
   public void setWaterJugProgress_(Integer waterJugProgress_) { this.waterJugProgress_ = waterJugProgress_; }
 
 
   
   public Integer getRebootTimer_() { return this.rebootTimer_; }
 
 
   
   public void setRebootTimer_(Integer rebootTimer_) { this.rebootTimer_ = rebootTimer_; }
 
 
   
   public Boolean getRebootIsRunning_() { return this.rebootIsRunning_; }
 
 
   
   public void setRebootIsRunning_(Boolean rebootIsRunning_) { this.rebootIsRunning_ = rebootIsRunning_; }
 
 
   
   public ArrayList<Integer> getMaze_() { return this.maze_; }
 
 
   
   public void setMaze_(ArrayList<Integer> maze_) { this.maze_ = maze_; }
 }

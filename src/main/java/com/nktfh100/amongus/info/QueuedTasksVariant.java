 ...
 {
   private Arena arena;
   private ArrayList<String> queuedTasks = new ArrayList<>();
   private Integer id;
   ...
   public ArrayList<String> getQueuedTasks() { return this.queuedTasks; }
 
 
   
   public void setQueuedTasks(ArrayList<String> newTasks) { this.queuedTasks = newTasks; }

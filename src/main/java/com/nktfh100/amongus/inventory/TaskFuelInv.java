 ...
 public class TaskFuelInv
   extends TaskInvHolder
 {
   private static ArrayList<ArrayList<Integer>> slots = new ArrayList<>();
   
   static  {
     slots.add(new ArrayList<>(Arrays.asList(new Integer[] { Integer.valueOf(38), Integer.valueOf(39) })));
     slots.add(new ArrayList<>(Arrays.asList(new Integer[] { Integer.valueOf(29), Integer.valueOf(30) })));
     slots.add(new ArrayList<>(Arrays.asList(new Integer[] { Integer.valueOf(20), Integer.valueOf(21) })));
     slots.add(new ArrayList<>(Arrays.asList(new Integer[] { Integer.valueOf(11), Integer.valueOf(12) })));
   }
   ...
   public Boolean checkDone() {
     if (this.isDone.booleanValue()) {
       ...
       final TaskFuelInv taskInv = this;
       (new BukkitRunnable()
         {
           public void run() {
